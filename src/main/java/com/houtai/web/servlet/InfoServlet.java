...
import com.houtai.service.impl.InfoServiceImpl;
...
public class InfoServlet extends BaseServlet {
    ...
    public void add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //转为Brand对象
        Info info = JSON.parseObject(params, Info.class);
    ...
    public void selectByPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setCharacterEncoding("UtF-8");
          //2.调用service查询,将查询结果封装为pageBean对象
            PageBean<Info> pageBean = infoService.selectByPage(currentPage, pageSize);
    ...
    public void selectByPageAndCoundition(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //2.调用service查询,将查询结果封装为pageBean对象
        PageBean<Info> pageBean = infoService.selectByPageAndCoundition(currentPage, pageSize,info);
    ...
    public void update(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
        ...
        Info _info = JSON.parseObject(params, Info.class);

        //将需要修改的内容封装为一个brand对象
        Info info=new Info();
        //brand.setId(id);
        info.setId(_info.getId());
        info.setSex(_info.getSex());
        info.setNumber(_info.getNumber());
     ...
     * @throws IOException
     */
    public void deleteInfoById(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
